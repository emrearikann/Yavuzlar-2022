...
if (isset($_POST["removeButton"])) {
   foreach ($results as $result) {
      $delMessage = $_POST["removeButton"];
      $del = $result["id"];
      if ($delMessage == $del) {
         $delete = $db->prepare("DELETE FROM contact WHERE id='$delMessage'");
      ...
      <div id="layoutSidenav_content">
         <main>
            <div class="container-fluid px-4">
               <h1 class="mt-4">ıncoming Messages</h1>
                     ...
                     <div class="row" style="display: flex;">
                        <div class="col" style="margin: 0 auto;">
                           <div class="card bg-warning text-white mb-4" style="display: flex;">
                              <div class="card-body">
                                 <h4 style="color: black;"><b>All Messages</b></h4>
                                 <?php
                                 $data = $db->prepare("SELECT * FROM contact");
                                 $data->execute(array());
                                 $results = $data->fetchAll();
                                 ...
                                 foreach ($results as $result) {
                                    echo  '<h5 style="color: black;"><b>' . $result["name"] . '</b></h5>
                                             <div style="display: flex; align-items: center; color: black; margin: 1rem; border-bottom: 1px solid black;">
                                                <p style="width: 100%"><b>E-mail</b>: ' . $result["email"] . '<br/><b>Phone:</b> ' . $result["phone"] . '<br/><b>Message: </b> ' . $result["message"] . ' </p>
